...
//  int recur(int row,int col,vector<vi> &mat){
//     if(row<0 || col<0)return -1;
//     int a = 1+ recur(row+1,col,mat);
//     int b = 1+recur(row,col+1,mat);
//    int c = 1+recur(row-1,col,mat);
//     int d = 1+recur(row,col-1,mat);
//     if(row==col)return min({a,b,c,d}); 
// }
